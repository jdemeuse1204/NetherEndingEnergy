...
public abstract class DestructibleContainer extends Container {
    ...
    protected DestructibleContainer(@Nullable ContainerType<?> type, int id) {
        super(type, id);
    }
            ...
            if (!itemstack6.isEmpty() || !itemstack10.isEmpty()) {
                if (itemstack6.isEmpty()) {
                    if (slot4.canTakeStack(player)) {
                        ...
                        //((Slot)slot4).onSwapCraft(itemstack10.getCount());
