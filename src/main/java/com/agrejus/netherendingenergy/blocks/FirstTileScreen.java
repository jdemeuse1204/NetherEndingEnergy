...
public class FirstTileScreen extends ContainerScreen<FirstTileContainer> {

    private ResourceLocation GUI = new ResourceLocation(NetherEndingEnergy.MODID, "textures/gui/firsttile_gui.png");

    public FirstTileScreen(FirstTileContainer container, PlayerInventory inv, ITextComponent name) {
