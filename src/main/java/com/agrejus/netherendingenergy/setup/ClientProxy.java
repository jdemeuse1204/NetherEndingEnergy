...
import com.agrejus.netherendingenergy.blocks.terra.link.TerraLinkScreen;
...
public class ClientProxy implements IProxy {
    ...
    public void init() {
        ...
        ScreenManager.registerFactory(ModBlocks.TERRA_LINK_CONTAINER, TerraLinkScreen::new);
